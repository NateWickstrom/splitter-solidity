...
contract('Splitter', function(accounts) {
  ...
  it("deposit should split amount between two accounts, with remander going to first", function() {
    var meta;
    ...
    return Splitter.deployed().then(function(instance) {
      ...
      assert.equal(account_one_starting_balance + 5, account_one_ending_balance,
        "account one did not receiver half of the funds plus the remander");
      assert.equal(account_two_starting_balance + 4, account_two_ending_balance,
        "account two did not receiver half of the funds");
    });
  });
